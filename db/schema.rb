...
ActiveRecord::Schema.define(version: 20180127065120) do
  ...
  create_table "friend_additions", force: :cascade do |t|
    t.integer "friend_list_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["friend_list_id"], name: "index_friend_additions_on_friend_list_id"
    t.index ["user_id"], name: "index_friend_additions_on_user_id"
  end
  ...
  create_table "friend_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owner_id"], name: "index_friend_lists_on_owner_id"
  end
