...
#missing Kite
  ...
  Song.create(title: "Now and Then", track_num: 10, duration: minutes_to_seconds('3:57'), album_id: Album.find_by(title: 'Voyager').id ,link: 'http://res.cloudinary.com/masag0/video/upload/v1520914594/Moonchild_-_Now_and_Then_vgx8pp.mp3')
